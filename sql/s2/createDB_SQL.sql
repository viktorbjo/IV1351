-- Detta databsa programm har modifierats från TASK2 för att tillfreställa det krav som finns i TASK3 
...
CREATE TABLE siblings (
 student_id INT,
 student_siblings_id INT,
 PRIMARY KEY (student_id,student_siblings_id)
);
