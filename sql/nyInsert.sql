...
INSERT INTO instructor (id, first_name, last_name, age, home_address, salary_per_hour, person_number, instrument_type) VALUES
  ...
  INSERT INTO student (id, first_name, last_name, home_address, person_number, age)
VALUES
...
INSERT INTO email (id, email_address)
...
VALUES (101, '555-555-5555');


INSERT INTO student_phone (student_id, phone_id)
VALUES (1, 101);
...
INSERT INTO ensemble (id, scheduled_time_slot, target_genre, min_student_req, max_student_req, instructor_id, school_id)
VALUES (1, '2022-01-01 10:00:00', 'Classical', 5, 10, 1, 1),
       (2, '2022-01-01 11:00:00', 'Jazz', 3, 6, 2, 1),
       (3, '2022-01-01 12:00:00', 'Rock', 4, 8, 3, 2),
       (4, '2022-01-01 13:00:00', 'Blues', 2, 4, 4, 2),
       (5, '2022-01-01 14:00:00', 'Pop', 6, 12, 5, 3);

INSERT INTO group_lesson (id, min_student_req, max_student_req, scheduled_time_slot, venue, instructor_id, skill_level, student_id)
VALUES
...
INSERT INTO individual_lesson (id, available_time, instructor_id, skill_level, student_id)
VALUES
...
INSERT INTO parent (student_id, first_name, last_name, age, home_address, person_number)
VALUES
...
INSERT INTO rent_instrument (student_id, price_monthly, start_leasing, quantity_of_instrument, brand_type, instrument_type, return_leased_instrument, brand_price, instrument_type_price)
VALUES (1, '100', '2022-12-08 10:00:00', '1', 'Fender', 'Guitar', '2022-12-09 10:00:00', '50', '25'),
...
INSERT INTO school (id, avalible_seats, address_of_school, student_id, instructor_id)
VALUES
...
INSERT INTO siblings (student_id, number_of_siblings)
VALUES
(1, 1),
(2, 3),
(3, 0),
...
INSERT INTO booking (school_id, lesson_type, booking_time)
VALUES
...
INSERT INTO discount (id, discount_rate, siblings_id)
VALUES (1, '0.20', 1),
       (2, '0.15', 2),
       (3, '0.10', 3),
       (4, '0.05', 4),
...
INSERT INTO monthly_fee (student_id, discount_id, total_sum, group_advanced_price, individual_advanced_price, group_intermediate_price, individual_intermediate_price, group_beginner_price, individual_beginner_price)
VALUES (1, 1, 100, 50, 60, 40, 45, 30, 35),
       (2, 2, 110, 55, 65, 45, 50, 35, 40),
       (3, 3, 120, 60, 70, 50, 55, 40, 45),
       (4, 4, 130, 65, 75, 55, 60, 45, 50),
       (5, 5, 140, 70, 80, 60, 65, 50, 55);

INSERT INTO number_of_lessons (instructor_id, student_id, discount_id, count_advanced_group_lessons, count_advanced_individual_lessons, count_intermediate_group_lessons, count_intermediate_individual_lessons, count_beginner_group_lessons, count_beginner_individual_lessons)
VALUES (1, 1, 1, 10, 10, 5, 5, 3, 3),
       (2, 2, 2, 8, 8, 4, 4, 2, 2),
       (3, 3, 3, 6, 6, 3, 3, 1, 1),
       (4, 4, 4, 4, 4, 2, 2, 0, 0),
       (5, 5, 5, 2, 2, 1, 1, 0, 0);

INSERT INTO schedule (instructor_id, school_id, available_time)
VALUES (1, 1, '2022-12-08 10:00:00'),
